"""Example implementation of a chemistry profile for TauREx."""
...
class ExampleChemistry(Chemistry):
    ...
    This class creates a chemistry profile
    ...
    def __init__(self, molecules=None, fractions=None):
        ...
        self.info("Passed fractions %s", fractions)
        ...
        if len(self._molecules) != len(self._fractions):
            ...
            # in size
            self.error(
                "Molecules and fractions do not match! %s != %s",
                len(self._molecules),
                len(self._fractions),
            )
    ...
    def initialize_chemistry(
        ...
        for mol, frac in zip(self._molecules, normalize_frac, strict=False):
    ...
    def setup_molecule_parameters(self):
        ...
        for idx, molecule in enumerate(self._molecules):
            ...
            self.add_fittable_param(
                param_name, param_latex, mol_getter, mol_setter, "log", False, bounds
            )
