...
class Plotter(object):
    ...
    def plot_fit_xprofile(self):
        ...
        for solution_idx, solution_val in self.solution_iter():
            ...
            plt.savefig(os.path.join(self.out_folder, '%s_fit_active_mixratio_sol%i.pdf' % (self.prefix, solution_idx)))
            plt.close('all')
        ...
        for solution_idx, solution_val in self.solution_iter():
            ...
            plt.savefig(os.path.join(self.out_folder, '%s_fit_inactive_mixratio_sol%i.pdf' % (self.prefix, solution_idx)))
            plt.close('all')
    ...
    def _plot_tau(self,contribution,pressure,wavelength):
        ...
        plt.ylim(y_labels[0] / 1.e5, y_labels[-1] / 1.e5)
        plt.yscale('log')
